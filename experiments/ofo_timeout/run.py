...
if __name__=="__main__":
    for i in range(4, 5):
        ...
        for delay in [40000, 80000, 120000]:
       	    for ofo_timeout in [0, 100000, 200000, 300000, 400000, 500000, 600000, 700000, 800000, 900000, 1000000]:
                result_th, result_cpu_sender, result_cpu_receiver, batching_efficiency, ofoPkts = measure(delay, 10000, 0, ofo_timeout)
                print result_th, result_cpu_sender, result_cpu_receiver, batching_efficiency, ofoPkts
                f.write('{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\n'.format(delay, 10000, 0, ofo_timeout, result_th, result_cpu_sender, result_cpu_receiver, batching_efficiency, ofoPkts))
        f.close()
