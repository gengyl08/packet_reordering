...
def measure(kernel, cross_flow):
	...
	receiver_thread = subprocess.Popen('runlocalssh googlesh -uroot -corp -d1 -m{} killall iperf; taskset -c 22 /home/akabbani/nettools/iperf -s -i 1'.format(receiver).split())
	time.sleep(5)
